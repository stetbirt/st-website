                    ...
                    <div className="">
                        <div className="lg:mb-0 mb-10">
                            <div className="group w-full">
                                <div className="relative container-height lg:rounded-l-xl rounded-xl" style={{backgroundImage: `url(/src/Assets/images/1.jpg)`}}>
                                    ...
                                    <div className="absolute bottom-0 w-full lg:p-11 p-5">
                                        <div className="bg-white rounded-lg p-6 block">
                                            <a href="" className="link-item flex items-center mb-6">
                                                ...
                                                <h5 className="text-black text-base font-normal leading-6 ml-5">stetbirt@gmail.com</h5>
                                            </a>
                                            <a href="" className="link-item flex items-center mb-6">
